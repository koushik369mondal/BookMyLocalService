        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3 mt-4">
              ...
              {/* Instagram Icon */}
              <a href="#" aria-label="Instagram" className="p-2 bg-slate-900 hover:bg-blue-600 hover:text-white rounded-full text-slate-400 transition-all duration-300 hover:scale-110">
              ...
              {/* X / Twitter Icon */}
              <a href="#" aria-label="Twitter" className="p-2 bg-slate-900 hover:bg-blue-600 hover:text-white rounded-full text-slate-400 transition-all duration-300 hover:scale-110">
                <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24">
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3 text-sm">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <a href="mailto:support@bookmylocalservice.com" className="hover:text-blue-500 transition-colors">support@bookmylocalservice.com</a>
              </div>
            </div>
