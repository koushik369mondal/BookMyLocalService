              ...
              <div className="flex flex-col sm:flex-row items-center gap-5 pb-6 border-b border-slate-100">
                <div className="relative group cursor-pointer" onClick={handlePhotoClick}>
                  <Avatar className="w-20 h-20 border-2 border-slate-100 shadow-md rounded-full overflow-hidden shrink-0">
                    ...
                    <AvatarFallback className="text-xl font-bold bg-indigo-50 text-indigo-700">{initials}</AvatarFallback>
                  </Avatar>
                ...
                <div className="space-y-1 text-center sm:text-left">
                  ...
                  <div className="flex items-center gap-2.5 pt-2">
                    <Button 
                      ...
                      size="xs" 
                      className="bg-blue-600 hover:bg-blue-700 text-white rounded-xl text-[10px] font-bold h-8 px-4"
                    >
              ...
              <form onSubmit={handleSubmit(onProfileSave)} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Input
                        id="state"
                        placeholder="NY"
                        className="h-10 border-slate-200 focus:ring-2 focus:ring-blue-500 rounded-xl text-xs bg-white text-center"
                        disabled={isSubmitting}
                        {...register("state")}
                      />
                    </div>
                ...
                <div className="pt-6 border-t border-slate-100 flex items-center justify-end gap-3.5">
                  ...
                  <Button 
                    type="submit" 
                    disabled={isSubmitting}
                    className="bg-blue-600 hover:bg-blue-700 text-white font-bold text-xs h-10 px-8 rounded-xl shadow-xs"
                  >
