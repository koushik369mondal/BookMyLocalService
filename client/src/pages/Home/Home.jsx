      ...
      <div className="bg-slate-50 min-h-screen">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
              ...
              <div className="lg:col-span-7 flex flex-col gap-6 text-center lg:text-left">
                <span className="inline-flex items-center gap-1.5 self-center lg:self-start bg-blue-50 text-blue-600 text-xs font-semibold px-3 py-1 rounded-full border border-blue-100">
                  <Star className="h-3 w-3 fill-blue-600" /> Vetted Local Professionals
                </span>
                <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-gray-900 leading-tight">
                  Your Trusted Partner for <span className="text-blue-600">Local Services</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center mt-2">
                  <NavLink to="/services" className="w-full sm:w-auto">
                    <Button size="lg" className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white rounded-full font-semibold shadow-md px-8 h-12 transition-transform hover:scale-[1.02]">
                      Book a Service
                    </Button>
                  </NavLink>
                  <NavLink to="/provider/dashboard" className="w-full sm:w-auto">
                    <Button size="lg" variant="outline" className="w-full sm:w-auto border-gray-300 hover:bg-gray-50 rounded-full font-semibold px-8 h-12">
                      Become a Provider
                    </Button>
                  </NavLink>
                </div>
                ...
                {/* SEARCH SECTION */}
                <div className="bg-white p-4 sm:p-5 rounded-2xl shadow-xl border border-gray-100 max-w-2xl mt-6 flex flex-col sm:flex-row gap-4 items-center">
                  <div className="relative w-full flex-1">
                    <MapPin className="absolute left-3.5 top-3.5 h-4 w-4 text-blue-500" />
                    <Input placeholder="Your location..." className="pl-10 h-11 border-gray-200 focus-visible:ring-blue-500 rounded-xl bg-gray-50/50" />
                  </div>
                  <div className="relative w-full flex-grow-[1.5]">
                    <Search className="absolute left-3.5 top-3.5 h-4 w-4 text-blue-500" />
                    <Input placeholder="What service do you need?" className="pl-10 h-11 border-gray-200 focus-visible:ring-blue-500 rounded-xl bg-gray-50/50" />
                  </div>
                  <Button className="w-full sm:w-auto h-11 bg-blue-600 hover:bg-blue-700 text-white rounded-xl px-8 shadow-xs transition-all">
                    Search
                  </Button>
                </div>
              ...
              <div className="lg:col-span-5 relative flex justify-center">
                <div className="absolute -inset-4 bg-blue-100 rounded-full filter blur-2xl opacity-50 scale-95 animate-pulse pointer-events-none"></div>
                <img 
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
              {steps.map((step, idx) => (
                <div key={idx} className="flex flex-col gap-4 text-center group px-4">
                  <span className="text-6xl font-extrabold text-blue-100 group-hover:text-blue-500 transition-colors select-none duration-300">
                    {step.step}
                  </span>
        ...
        <section className="py-16 md:py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-12">
            ...
            <NavLink to="/services" className="inline-flex items-center gap-1 text-sm font-semibold text-blue-600 hover:text-blue-700 transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {providers.map((provider, idx) => (
              <Card key={idx} className="overflow-hidden p-0 py-0 gap-0 hover:shadow-lg transition-all duration-300 border border-gray-100 flex flex-col h-full bg-white">
                ...
                <div className="p-5 flex flex-col gap-4 flex-1">
                  <div>
                    <h4 className="text-xs font-semibold uppercase tracking-wider text-blue-600">{provider.service}</h4>
                    <h3 className="font-bold text-gray-900 text-lg mt-1">{provider.name}</h3>
                  </div>
                  ...
                  <NavLink to="/booking" className="w-full">
                    <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white rounded-xl h-10 mt-1 shadow-xs">
                      Book Now
                    </Button>
                  </NavLink>
                </div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 rounded-3xl text-white py-12 px-6 sm:px-12 md:py-16 md:px-20 text-center relative overflow-hidden shadow-xl">
            ...
            <div className="relative z-10 max-w-3xl mx-auto flex flex-col gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-4">
                <NavLink to="/services">
                  <Button size="lg" className="w-full sm:w-auto bg-white hover:bg-gray-100 text-blue-600 rounded-full font-semibold shadow-md px-8 h-12 transition-transform hover:scale-[1.02]">
                    Book a Service
                  </Button>
                </NavLink>
