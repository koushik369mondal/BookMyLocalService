        ...
        <section className="bg-[#F0E7D5] border-b border-[#E8DCC3] py-8 text-[#1F1D1A]">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="space-y-1">
              <h1 className="text-xl sm:text-2xl font-bold tracking-tight text-[#1F1D1A]">Manage Platform Users</h1>
              <p className="text-[#5A5146] text-xs sm:text-sm font-medium">Audit profiles, modify roles, block accounts, or export databases</p>
            </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 bg-white border border-[#E8DCC3] p-5 rounded-2xl shadow-2xs">
            ...
            <div className="text-center space-y-1 py-1 border-l border-[#E8DCC3]">
              <span className="block text-2xl font-bold text-[#2B522B]">{stats.active}</span>
              <span className="text-[10px] font-bold text-[#7A7266] uppercase tracking-wider block">Active Users</span>
            </div>

            <div className="text-center space-y-1 py-1 border-l border-[#E8DCC3]">
              <span className="block text-2xl font-bold text-[#8C4B3E]">{stats.blocked}</span>
              <span className="text-[10px] font-bold text-[#7A7266] uppercase tracking-wider block">Blocked Users</span>
            </div>

            <div className="text-center space-y-1 py-1 border-l border-[#E8DCC3]">
              <span className="block text-2xl font-bold text-[#C9A46A]">+{stats.newCount}</span>
              ...
              {selectedUserIds.length > 0 && (
                <div className="p-4 bg-[#8C4B3E] border border-violet-950 text-white rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4 animate-fade-in shadow-md">
                  <span className="text-xs font-extrabold flex items-center gap-2">
                    <SlidersHorizontal className="h-4.5 w-4.5 text-[#8C4B3E]" />
                    ...
                    <table className="w-full text-xs text-left">
                      ...
                      <tbody className="divide-y divide-stone-50 font-medium text-[#8C4B3E]">
                        {paginatedUsers.map(user => {
                          ...
                          return (
                            <tr key={user.id} className={`hover:bg-[#FAF6F0] transition-colors ${isSelected ? "bg-[#8C4B3E]/5/10" : ""}`}>
          ...
          <DialogContent className="max-w-md bg-white border border-[#5A5146]/20 rounded-2xl shadow-xl p-6">
            ...
            <form onSubmit={onEditSaveSubmit} className="space-y-4 pt-3">
              ...
              <div className="space-y-1.5">
                <Label htmlFor="editName" className="text-xs font-bold text-[#8C4B3E]">Full Name</Label>
                <Input
                  id="editName"
                  value={editName}
              ...
              {/* Email */}
              <div className="space-y-1.5">
                <Label htmlFor="editEmail" className="text-xs font-bold text-[#8C4B3E]">Email Address</Label>
                <Input
                  id="editEmail"
                  type="email"
                  value={editEmail}
              ...
              {/* Phone */}
              <div className="space-y-1.5">
                <Label htmlFor="editPhone" className="text-xs font-bold text-[#8C4B3E]">Phone Contact</Label>
                <Input
                  id="editPhone"
                  value={editPhone}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <Label htmlFor="editRole" className="text-xs font-bold text-[#8C4B3E]">Role</Label>
                  <div className="relative">
                    <select
                      id="editRole"
                      value={editRole}
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="editStatus" className="text-xs font-bold text-[#8C4B3E]">Status</Label>
                  <div className="relative">
                    <select
                      id="editStatus"
                      value={editStatus}
