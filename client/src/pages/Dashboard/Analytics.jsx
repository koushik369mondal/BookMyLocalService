        ...
        <section className="bg-gradient-to-r from-blue-600 via-indigo-650 to-indigo-750 text-white py-12 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            <div className="space-y-1.5">
              ...
              <p className="text-blue-100 text-xs sm:text-sm font-medium">Verify system transaction spline logs, category sharing indexes, and demographics</p>
            </div>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-6 relative z-20">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            ...
            <Card className="border border-slate-100 shadow-md bg-white p-5 flex items-center justify-between gap-3.5 rounded-2xl hover:scale-[1.01] transition-transform">
              ...
              <div className="p-2.5 bg-emerald-50 text-emerald-650 rounded-xl shrink-0">
            ...
            <Card className="border border-slate-100 shadow-md bg-white p-5 flex items-center justify-between gap-3.5 rounded-2xl hover:scale-[1.01] transition-transform col-span-2 md:col-span-1">
              <div className="space-y-1">
                ...
                <span className="text-xl sm:text-2xl font-black text-blue-650">+15.4%</span>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
                            ...
                            return (
                              <g key={d.label}>
                                <rect
                                  ...
                                  rx="4"
                                  fill="#2563eb"
                                  className="hover:fill-indigo-650 transition-colors cursor-pointer"
                                />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <Card className="lg:col-span-4 border border-slate-100 shadow-2xs rounded-2xl bg-white p-6 space-y-4">
              ...
              <div className="space-y-4">
                {topPerformers.map(prov => (
                  <div key={prov.id} className="p-3 border border-slate-150 rounded-xl bg-white shadow-2xs flex items-center justify-between gap-3 hover:border-slate-250 transition-colors">
              ...
              <div className="space-y-4">
                {demographics.map(cat => (
                  <div key={cat.borough} className="space-y-1">
                    ...
                    <Progress value={cat.percentage} className="h-2 rounded-full bg-slate-100 [&>div]:bg-blue-600" />
                  </div>
                ))}
              </div>
            </Card>
            ...
            <Card className="lg:col-span-4 border border-slate-100 shadow-2xs rounded-2xl bg-white p-6 space-y-4">
              ...
              <div className="relative pl-4 border-l border-slate-150 space-y-5 pt-1.5 ml-1 text-xs">
                {activityLogs.map(log => (
                  <div key={log.id} className="relative group animate-fade-in">
                    
                    {/* Ring dot indicator */}
                    <span className="absolute -left-[20.5px] top-1 h-3.5 w-3.5 rounded-full border border-white bg-blue-600 ring-2 ring-blue-105 shrink-0"></span>
