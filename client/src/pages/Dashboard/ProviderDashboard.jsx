...
export default function ProviderDashboard() {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      ...
      case "confirmed":
        return <Badge className="bg-slate-900/50 border-0 hover:bg-slate-900 text-white font-bold rounded-lg px-2.5 py-0.5 text-[9px] uppercase">Confirmed</Badge>;
      case "completed":
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              <Button 
                ...
                size="sm" 
                className="bg-white text-slate-900 hover:bg-slate-50 rounded-full text-xs font-bold px-5 h-9.5 shadow-md flex items-center gap-1.5"
              >
                                ...
                                <div className="flex justify-end gap-1.5">
                                  ...
                                  {b.status === "confirmed" && (
                                    <Button
                                      ...
                                      className="bg-slate-900 hover:bg-slate-900 text-white font-bold h-7 rounded-lg text-[9px] py-0 px-2"
                                    >
                                      Mark Completed
                                    </Button>
                                  )}
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <Card className="border border-slate-100 shadow-2xs rounded-2xl bg-white p-5 space-y-4">
                ...
                <div className="flex items-center gap-3.5 p-3.5 bg-slate-50 border border-slate-100 rounded-xl">
                  ...
                  <div>
                    <Badge className="bg-slate-900/5 hover:bg-slate-900/10 border border-slate-900/10 text-slate-900 font-bold rounded-lg text-[9px] uppercase py-0 px-2 leading-none">
                      Verified Specialist
                    </Badge>
              ...
              <Card className="border border-slate-100 shadow-2xs rounded-2xl bg-white p-5">
                <span className="text-xs font-extrabold text-slate-400 uppercase tracking-wider block mb-3 flex items-center gap-1.5">
                  <Bell className="h-4 w-4 text-slate-900 animate-swing" /> Operations Alerts
                </span>
              ...
              <Card className="border border-slate-100 shadow-2xs rounded-2xl bg-white p-5 space-y-4">
                ...
                <div className="space-y-2.5">
                  {services.map(svc => (
                    <div key={svc.id} className="flex items-center justify-between p-3 border border-slate-200 rounded-xl bg-white shadow-2xs group hover:border-slate-300 transition-colors">
